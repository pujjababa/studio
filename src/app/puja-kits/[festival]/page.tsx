...
import type { PujaSamagri } from '@/lib/types';
...
export default function PujaKitPage() {
    ...
    const festivalName = decodeURIComponent(params.festival as string);
    
    const kit = pujaKitsData.find(k => k.festival_hindi === festivalName);
    ...
    const handleQuantityChange = (index: number, newQuantity: number) => {
        ...
        const originalPricePerUnit = item.price_inr / item.quantity;
        
        item.quantity = newQuantity;
        item.price_inr = originalPricePerUnit * newQuantity;
